...
package org.rapidpm.demo.entwicklerpress.shortcut.proxies.chap3.chap_3_1;
...
public class CHAP_3_1_Demo {
    ...
    class RealSubject implements Subject {
        public void request() {
            System.out.println("RealSubject.request(); = " + new Date());
        }
    }
    ...
    public static void main(String[] args) {
        CHAP_3_1_Demo main = new CHAP_3_1_Demo();
