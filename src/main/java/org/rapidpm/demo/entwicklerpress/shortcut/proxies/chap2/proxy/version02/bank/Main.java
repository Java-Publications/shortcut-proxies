...
package org.rapidpm.demo.entwicklerpress.shortcut.proxies.chap2.proxy.version02.bank;
...
public class Main {
    public static void main(String[] args) {
        ...
        KontoMitPasswort kontoMitPasswort = new KontoMitPasswort(new Konto(), "test");
